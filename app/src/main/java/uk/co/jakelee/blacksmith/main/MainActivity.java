...
public class MainActivity extends AppCompatActivity {
    ...
    public void execSQL() {
        ...
        Location location = new Location(0L, "Anvil");
        Location location1 = new Location(1L, "Furnace");
        Location location2 = new Location(2L, "Selling");
        Location location3 = new Location(3L, "Mine");
        Location location4 = new Location(4L, "Table");
        ...
        Shop_Stock shopStock = new Shop_Stock(0L, 1L, 4, 1, 5);
        Shop_Stock shopStock1 = new Shop_Stock(0L, 2L, 4, 1, 5);
        Shop_Stock shopStock2 = new Shop_Stock(1L, 1L, 3, 1, 10);
        Shop_Stock shopStock3 = new Shop_Stock(1L, 2L, 3, 1, 10);
        Shop_Stock shopStock4 = new Shop_Stock(2L, 3L, 8, 1, 10);
        Shop_Stock shopStock5 = new Shop_Stock(3L, 2L, 3, 1, 10);
        Shop_Stock shopStock6 = new Shop_Stock(4L, 9L, 8, 1, 1);
        Shop_Stock shopStock7 = new Shop_Stock(4L, 8L, 8, 1, 1);

        Slots slots = new Slots(0L, 0, 0, 0);
        Slots slots1 = new Slots(1L, 0, 10, 0);
        Slots slots2 = new Slots(2L, 0, 20, 0);
        Slots slots3 = new Slots(3L, 1, 0, 0);
        Slots slots4 = new Slots(4L, 1, 5, 0);
        Slots slots5 = new Slots(5L, 1, 5, 0);
        Slots slots6 = new Slots(6L, 2, 0, 0);
        Slots slots7 = new Slots(7L, 2, 10, 0);
        Slots slots8 = new Slots(8L, 2, 20, 0);
        Slots slots9 = new Slots(9L, 3, 0, 0);
        Slots slots10 = new Slots(10L, 3, 5, 0);
        Slots slots11 = new Slots(11L, 3, 10, 0);
        Slots slots12 = new Slots(12L, 4, 1, 0);
        Slots slots13 = new Slots(13L, 4, 1, 0);
        Slots slots14 = new Slots(14L, 4, 1, 0);
        Slots slots15 = new Slots(15L, 4, 1, 0);
