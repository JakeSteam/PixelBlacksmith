...
import uk.co.jakelee.blacksmith.model.*;
...
public class UpgradeHelper {
    ...
    public static void initialSQL() {
        ...
        uk.co.jakelee.blacksmith.model.Character character = new Character(0L, "S. Keeper", "He looks a little bit shifty...", "Greetings! See anything you like?", "Remember, no refunds!");
        character.save();
