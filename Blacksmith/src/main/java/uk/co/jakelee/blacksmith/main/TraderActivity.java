...
public class TraderActivity extends Activity implements AlertDialogCallback {
    ...
    public void clickRestock(View v) {
        ...
        if (restockCost > 0) {
            ...
            ToastHelper.showToast(findViewById(R.id.trader), ToastHelper.SHORT, R.string.unnecessaryRestock, false);
        }
    }
    ...
    public void callbackRestock() {
        trader.restock(0);
        ToastHelper.showToast(findViewById(R.id.trader), ToastHelper.LONG, R.string.traderRestockCompleteAdvert, true);
        createTraderInterface();
    }
