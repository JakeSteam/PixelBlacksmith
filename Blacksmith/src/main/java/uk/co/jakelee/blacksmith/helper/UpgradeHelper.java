...
public class UpgradeHelper {
    ...
    public static void initialSQL() {
        ...
        Visitor_Stats vStats1 = new Visitor_Stats(1L, 5, 1L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats2 = new Visitor_Stats(2L, 10, 2L, 2L, 2, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats3 = new Visitor_Stats(3L, 10, 3L, 3L, 3, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats4 = new Visitor_Stats(4L, 10, 4L, 4L, 4, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats5 = new Visitor_Stats(5L, 10, 5L, 1L, 5, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats6 = new Visitor_Stats(6L, 10, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats7 = new Visitor_Stats(7L, 10, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats8 = new Visitor_Stats(8L, 10, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats9 = new Visitor_Stats(9L, 10, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats10 = new Visitor_Stats(10L, 20, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats11 = new Visitor_Stats(11L, 20, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats12 = new Visitor_Stats(12L, 20, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        Visitor_Stats vStats13 = new Visitor_Stats(13L, 20, 52L, 1L, 1, 1452022352000L, 1454841674000L);
        vStats1.save();
        vStats2.save();
        vStats3.save();
        vStats4.save();
