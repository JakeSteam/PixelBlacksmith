...
public class EventHelper {
    public static void checkForEasterEggs(Activity activity) {
        if (VisitorHelper.getRandomBoolean(70)) {
            ...
            Item item = Item.findById(Item.class, 130);
            Inventory.addItem(item.getId(), state, 1, false);
            ToastHelper.showPositiveToast(null, ToastHelper.SHORT, String.format(Locale.ENGLISH, activity.getString(R.string.eventEasterItem),
