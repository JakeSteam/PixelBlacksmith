...
public class HelpActivity extends Activity {
    ...
    public void displayHelpVisitor(LinearLayout layout) {
        ...
        layout.addView(dh.createTextView("Once all required trades have been completed, the visitor can be completed. Alternatively, they can be shooed away (for a cost).\n", 22));
    }
