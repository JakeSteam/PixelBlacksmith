...
public class DatabaseHelper {
    ...
    public static void initialSQL() {
        ...
        new Item(1L, "Copper ore", "A piece of copper ore.", 1, 10, 1, 0, 1);
        new Item(2L, "Tin ore", "A piece of tin ore.", 1, 10, 1, 0, 1);
        new Item(3L, "Coal", "A piece of coal.", 1, 10, 1, 0, 1);
        new Item(4L, "Iron ore", "A piece of iron ore.", 1, 10, 1, 0, 1);
        new Item(5L, "Mithril ore", "A piece of mithril ore.", 1, 10, 1, 0, 1);
        new Item(6L, "Adamantite ore", "A piece of adamantite ore.", 1, 10, 1, 0, 1);
        new Item(7L, "Runite ore", "A piece of runite ore.", 1, 10, 1, 0, 1);
        new Item(8L, "Gold ore", "A piece of gold ore.", 1, 10, 1, 0, 1);
        new Item(9L, "Silver ore", "A piece of silver ore.", 1, 10, 1, 0, 1);
        new Item(10L, "Dragonite ore", "A piece of dragonite ore.", 1, 10, 1, 0, 1);
        new Item(11L, "Bronze bar", "A fresh bar of bronze.", 2, 10, 3, 1, 0);
        new Item(12L, "Iron bar", "A fresh bar of iron.", 2, 10, 3, 5, 0);
        new Item(13L, "Steel bar", "A fresh bar of steel.", 2, 10, 3, 10, 0);
        new Item(14L, "Mithril bar", "A fresh bar of mithril.", 2, 10, 3, 20, 0);
        new Item(15L, "Adamant bar", "A fresh bar of adamant.", 2, 10, 3, 30, 0);
