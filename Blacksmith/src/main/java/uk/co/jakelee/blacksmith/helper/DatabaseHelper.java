...
public class DatabaseHelper {
    ...
    private static void createPlayerInfo() {
        ...
        new Player_Info("CoinsEarned", 0, 0);
    ...
    public static void createVisitorType() {
        ...
        new Visitor_Type(5L, "Grumbling Rock", "Me hungry. Tummy rumbling.", 11L, 1L, 1L, 1.05, 1.4, 1.05, false, false, false, 5);
        new Visitor_Type(6L, "Large Grumbling Rock", "Me very hungry. Tummy rumbling loud.", 11L, 1L, 1L, 1.6, 1.8, 1.05, false, false, false, 1);
        ...
        new Visitor_Type(12L, "Gelatinous Egg", "So what if I'm not quite in shape?", 11L, 19L, 2L, 1.05, 1.15, 1.1, false, false, false, 8);
        new Visitor_Type(13L, "The Great Cheese Menace", "You there! Got any of the yellow stuff?", 11L, 21L, 1L, 1.05, 1.55, 1.05, false, false, false, 6);
        new Visitor_Type(14L, "The Leech King", "Slurp, slurp.", 7L, 4L, 7L, 1.25, 1.25, 1.25, false, false, false, 3);
        new Visitor_Type(15L, "Man of Magicka", "Do you like my outfit?", 11L, 14L, 7L, 1.05, 1.05, 1.05, false, false, false, 7);
        ...
        new Visitor_Type(22L, "Marcell", "I've got shoes on.", 11L, 19L, 1L, 1.01, 1.01, 1.01, false, false, false, 5);
        new Visitor_Type(23L, "Crabby", "Snippy, snippy!", 11L, 3L, 1L, 1.02, 1.02, 1.02, false, false, false, 3);
        ...
        new Visitor_Type(25L, "Magical Mushroom", "No nibbling.", 11L, 21L, 1L, 1.01, 1.15, 1.05, false, false, false, 5);
        ...
        new Visitor_Type(29L, "Hatty", "I wish my hair wasn't so exposed to the elements.", 11L, 12L, 1L, 1.08, 1.15, 1.05, false, false, false, 5);
        ...
        new Visitor_Type(32L, "Whippersnapper", "Don't tell Steve, but his secret fish pond isn't so secret.", 11L, 17L, 4L, 1.05, 1.20, 1.02, false, false, false, 6);
