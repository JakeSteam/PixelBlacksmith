...
public class DatabaseHelper {
    ...
    public static void initialSQL() {
        ...
        new Item(3L, "Coal", "A piece of coal.", 1, 10, 5, 0);
        new Item(4L, "Iron ore", "A piece of iron ore.", 1, 10, 7, 0);
        ...
        new Item(13L, "Steel bar", "A fresh bar of steel.", 2, 10, 20, 10);
        new Item(14L, "Mithril bar", "A fresh bar of mithril.", 2, 10, 24, 20);
        new Item(15L, "Adamant bar", "A fresh bar of adamant.", 2, 10, 50, 30);
