...
public class DatabaseHelper {
    ...
    public static void initialSQL() {
        ...
        Item item81 = new Item(81L, "Mithril dagger", "A pretty good blue-tinted dagger.", 3, 4, 28, 20, 1);
        Item item82 = new Item(82L, "Mithril sword", "A slightly sharp sword, with a blue hue.", 4, 4, 56, 20, 1);
        Item item83 = new Item(83L, "Mithril longsword", "item = 'long' + previousItem;", 5, 4, 56, 20, 1);
        Item item84 = new Item(84L, "Mithril bow", "Use to fire arrows out of the blue.", 6, 4, 56, 20, 0);
        Item item85 = new Item(85L, "Mithril half shield", "A bl shi.", 7, 4, 56, 22, 0);
        Item item86 = new Item(86L, "Mithril full shield", "A blue shield.", 8, 4, 56, 22, 1);
        Item item87 = new Item(87L, "Mithril chainmail", "A set of mithril chainmail, seemingly for the smaller gentleman.", 9, 4, 56, 22, 1);
        Item item88 = new Item(88L, "Mithril platebody", "A more complete approach to sword-stopping.", 10, 4, 84, 24, 1);
        Item item89 = new Item(89L, "Mithril half helmet", "Blue on blue for you.", 11, 4, 56, 24, 1);
        Item item90 = new Item(90L, "Mithril full helmet", "Blue on more blue, still for you.", 12, 4, 84, 26, 1);
        Item item91 = new Item(91L, "Mithril boots", "Note: Despite appearances, you are not walking on water.", 13, 4, 28, 26, 1);
        Item item92 = new Item(92L, "Mithril gloves", "Note: Despite appearances, you are not washing your hands.", 14, 4, 28, 26, 1);
        Item item93 = new Item(93L, "Mithril pickaxe", "This pick is no myth!", 15, 4, 56, 28, 1);
        Item item94 = new Item(94L, "Mithril hatchet", "It's a shame magical blue trees don't exist.", 16, 4, 56, 28, 1);
        Item item95 = new Item(95L, "Mithril fishing rod", "The fish seem oddly attracted to the blue metal.", 17, 4, 56, 28, 1);
        Item item96 = new Item(96L, "Mithril hammer", "A heavier hammer that tends to hit the anvil. Just.", 18, 4, 25, 28, 1);
        item1.save();
        item2.save();
        item3.save();
        item4.save();
