...
public class DatabaseHelper {
    ...
    public static void initialSQL() {
        ...
        // Finishing mithril items
        Recipe recipe160 = new Recipe(160L, 81L, 1, 81L, 2, 1);
        Recipe recipe161 = new Recipe(161L, 81L, 1, 77L, 1, 1);
        Recipe recipe162 = new Recipe(162L, 82L, 1, 82L, 2, 1);
        Recipe recipe163 = new Recipe(163L, 82L, 1, 77L, 1, 1);
        Recipe recipe164 = new Recipe(164L, 83L, 1, 83L, 2, 1);
        Recipe recipe165 = new Recipe(165L, 83L, 1, 77L, 1, 1);
        Recipe recipe166 = new Recipe(166L, 84L, 1, 84L, 2, 1);
        Recipe recipe167 = new Recipe(167L, 84L, 1, 77L, 1, 1);
        Recipe recipe168 = new Recipe(168L, 85L, 1, 85L, 2, 1);
        Recipe recipe169 = new Recipe(169L, 85L, 1, 77L, 1, 1);
        Recipe recipe170 = new Recipe(170L, 86L, 1, 86L, 2, 1);
        Recipe recipe171 = new Recipe(171L, 86L, 1, 77L, 1, 1);
        Recipe recipe172 = new Recipe(172L, 87L, 1, 87L, 2, 1);
        Recipe recipe173 = new Recipe(173L, 87L, 1, 77L, 1, 1);
        Recipe recipe174 = new Recipe(174L, 88L, 1, 88L, 2, 1);
        Recipe recipe175 = new Recipe(175L, 88L, 1, 77L, 1, 1);
        Recipe recipe176 = new Recipe(176L, 89L, 1, 89L, 2, 1);
        Recipe recipe177 = new Recipe(177L, 89L, 1, 77L, 1, 1);
        Recipe recipe178 = new Recipe(178L, 90L, 1, 90L, 2, 1);
        Recipe recipe179 = new Recipe(179L, 90L, 1, 77L, 1, 1);
        Recipe recipe180 = new Recipe(180L, 91L, 1, 91L, 2, 1);
        Recipe recipe181 = new Recipe(181L, 91L, 1, 77L, 1, 1);
        Recipe recipe182 = new Recipe(182L, 92L, 1, 92L, 2, 1);
        Recipe recipe183 = new Recipe(183L, 92L, 1, 77L, 1, 1);
        Recipe recipe184 = new Recipe(184L, 93L, 1, 93L, 2, 1);
        Recipe recipe185 = new Recipe(185L, 93L, 1, 77L, 1, 1);
        Recipe recipe186 = new Recipe(186L, 94L, 1, 94L, 2, 1);
        Recipe recipe187 = new Recipe(187L, 94L, 1, 77L, 1, 1);
        Recipe recipe188 = new Recipe(188L, 95L, 1, 95L, 2, 1);
        Recipe recipe189 = new Recipe(189L, 95L, 1, 77L, 1, 1);
        Recipe recipe190 = new Recipe(190L, 96L, 1, 96L, 2, 1);
        Recipe recipe191 = new Recipe(191L, 96L, 1, 77L, 1, 1);
        recipe160.save();
        recipe161.save();
        recipe162.save();
        recipe163.save();
